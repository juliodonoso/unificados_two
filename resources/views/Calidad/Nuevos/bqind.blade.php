                    ...
                    <table class="table table-hover" id="tb01">
                        ...
                        @foreach($propuestas as $resp) 
                            ...
                            @endif 
                                ...
                                @endif
                                @if($resp->rutcar == $lbuscar)
                                    <td style="color:red;">{!! $resp->rutcar !!}</td>
                                @else
                                    <td>{!! $resp->rutcar !!}</td>
                                @endif
                                ...
                                @if($resp->rutcar == $lbuscar)
                                    <td>{!! $resp->rutter !!}</td>
                                @else
                                    <td style="color:red;">{!! $resp->rutter !!}</td>
                                @endif
                                <td>{!! $resp->tipif !!}</td>   
                                <td>{!! $resp->gtcall !!}</td>     
                                <td>{!! $resp->tpcall !!}</td>                                                                                                                     
                                <td class="text-right">
                                    <a href="#PlaceModal-{{$resp->id}}" data-toggle="modal" class="btn btn-link btn-info like" id="idlup"><i class="fa fa-search"></i></a>
                                    @if($period == $pe && $patst == 1)                                                 
                                        <a href="{{ route('editp',array('ldid' =>$resp->id)) }}" class="btn btn-link btn-warning edit"><i class="fa fa-edit"></i></a>                                          
                                    @endif               
                                </td>                               
                            </tr>
                        @endforeach
