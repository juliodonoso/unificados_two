            ...
            <form method="POST" id="formedit" name="formedit" action="{{ route('editupdate',array('Nrocar' =>$Nrocar,'ldid' =>$ldid)) }}">  
                ...
                @foreach($propedit as $resp)
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="sel04"name ="sisapre">
                                            ...
                                            <option value=43>PRUEBA ISAPRE</option>     
                                        </select>
                                    </div>
                                </div>                                                                                                                                                      
                                <div class="col-md-1">
                    ...
                    <div class="row" style="padding-top:0px;">
                        <div class="col-sm-12" id="datosp2" style="padding-top:0px;">
                            <div class="row"> 
                                <div class="col-md-1">
                                    <div class="form-group has-label">
                                        <label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group has-label">
                                        ...
                                        <textarea class="form-control" id="obs"  name ="pre" rows="5" placeholder="Observaciones" style="text-transform:uppercase; height: 90px;">{{$resp->obs}} </textarea>                                                                                         
                                    </div>
                                </div>                                                                             
                            </div>  
                        </div>   
                            ...
                            @foreach($lscargas as $cargas) 
                                ...
                                <div  class="form-groupx" id ="divc{{$lscoutn}}"> 
                                    ...
                                    <div id="divc8x"class="form-a">                                    
                                        <input type='date' id="fncg{{$lscoutn}}" name="fnaca{{$lscoutn}}" class="form-control"  value="{{$cargas->fnac}}" />                                                            
                                    </div> 
                ...
                <div class="row">                   
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control" id="observa" name="observa" rows="5" placeholder="Observaciones" style="text-transform:uppercase; height: 90px;">{{$resp->observaciones}} </textarea>
                        </div>
                    </div>
                </div>
            </form>
