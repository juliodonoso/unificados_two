...
<div class="col-md-12">
    <div class="card "> 
        <div class="card-header"> 
            <div id="botn">                    
                    <a href="{{ route('excelejecut') }}" class="btn btn-success" ><i class="fa fa-file-excel-o" aria-hidden="true"></i>Excel</a>  
                    <div id="bqrut">        
                        ...
                        <tbody>
                            @foreach($ejecutivos as $resp)                                                                                                                
                                <tr>
                                    ...
                                    <td class="tdsp2">{!! $resp->tparcial !!} %</td> 
                                    <td class="tdsp4">{!! $resp->tfinal !!} %</td>                                   
