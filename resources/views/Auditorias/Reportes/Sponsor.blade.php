                        ...
                        <tbody>
                            @foreach($sponsor as $resp)                                                                                                                
                                <tr>
                                    ...
                                    <td class="tdsp2">{!! round($resp->tparcial / $resp->cant) !!} %</td> 
                                    <td class="tdsp4">{!! round($resp->tfinal / $resp->cant) !!} %</td>                                   
                                    <td class="tdsp3">{!! $resp->cant !!}</td>                 
                                    <td class="tdsp">{!! round(($resp->cumple / $resp->cant)*100) !!} %</td>                                                              
                                </tr>                                        
                            @endforeach
                        </tbody>
                        <tfoot>
