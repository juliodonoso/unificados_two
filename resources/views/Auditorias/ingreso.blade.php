            ...
            <!-- Datos de la campaña-->
                <div class="row">
                    <div class="col-sm-12" id="Camp">  <!-- Sponsor / Campaña -->
                        <div class="row">
                            <div class="col-sm-6">         
                                <select required  data-title="Seleccione Sponsor"  id="super"  name="sponsor"  class="selectpicker" data-style="btn-info btn-fill btn-block" data-menu-style="dropdown-blue">                                                
                            ...
                            <div class="col-sm-6">         
                                <select required  data-title="Seleccione Campaña"  id="cia"  name="cia"  class="selectpicker"  data-style="btn-info btn-fill btn-block" data-menu-style="dropdown-blue">                                                
                    ...
                    <div class="col-sm-12" id="Oper">
                        <div class="row">
                            <div class="col-sm-6">         
                                <select required data-title="Seleccione Canal"  id="canal"  name="canal"  class="selectpicker" data-style="btn-info btn-fill btn-block" data-menu-style="dropdown-blue">                                                
                            ...
                            <div class="col-sm-6">         
                                <select required data-title="Seleccione Tele Operador"  id="telop"  name="telop"  class="selectpicker" data-style="btn-info btn-fill btn-block" data-menu-style="dropdown-blue">                                                
                                    @foreach($teleop as $select4)
                                        <option value="{{ $select4->id }}" id="operador">{{ $select4->name }}</option>                                   
                                    @endforeach
                                </select> 
