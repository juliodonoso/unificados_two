            ...
            <div class="row">
                <div class="col-sm-12" id="Camp">
                    <div class="row">
                        ...
                        <div class="col-sm-6">         
                            <select required  data-title="Seleccione Campaña"  id="super"  name="cia[]"  class="selectpicker"  data-style="btn-info btn-fill btn-block" data-menu-style="dropdown-blue">                                                
                                @foreach($campanias as $select2)
                                    <option value="{{ $select2->name }}">{{ $select2->name }}</option>
                                @endforeach
                            </select>                
                        </div> 
                    </div> 
                    ...
                    <div class="row">
                        <div class="col-sm-6">         
                            <select required data-title="Seleccione Tele Operador"  id="telop"  name="telop"  class="selectpicker" data-style="btn-info btn-fill btn-block" data-menu-style="dropdown-blue">                                                
                                @foreach($teleop as $select3)
                                    <option value="{{ $select3->name }}">{{ $select3->name }}</option>
                                @endforeach
                            </select>                
                        </div>                                            
                    </div>                    
