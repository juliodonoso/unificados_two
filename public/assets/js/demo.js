...
demo = {
    ...
    initCharts: function() {
        ...
        var dataViews = {
            labels: ['DVM', 'Feb', 'Mar', 'Apr', 'Mai', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
            series: [
        ...
        var data = {
            labels: ['MMMM', 'Feb', 'Mar', 'Apr', 'Mai', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
            series: [
                [542, 443, 320, 780, 553, 453, 326, 434, 568, 610, 756, 895],
    ...
    showNotification: function(from, align) {
        ...
        $.notify({
            ...
            message: "Bienvenido <b>a nuestro sistema</b>  -  La Herramienta de Gestion de Unificados."
